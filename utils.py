...
def plotPCbatch(pcArray1, pcArray2, show = True, save = False, name=None, fig_count=8 , sizex = 8, sizey=2):
    ...
    for i in range(fig_count*2):
        ...
        ax.set_xlim3d(0.25, 0.7)
        ax.set_ylim3d(0.25, 0.7)
        ax.set_zlim3d(0.25, 0.7)
